...
LEBAR_LAYAR, TINGGI_LAYAR = 1200, 700

endofX  = LEBAR_LAYAR / 2

endofY = TINGGI_LAYAR / 2
...
jendela_utama = glfw.create_window(LEBAR_LAYAR, TINGGI_LAYAR, "Simple Workshop", None, None)
...
from obj_box1 import vertices_box1, indices_box1, vertices_box3, vertices_box2
...
objects = {
    ...
    "box2" : (vertices_box2, indices_box1),
    "box3" : (vertices_box3, indices_box1),
...
# This part is a function for calling VAO creation (used for rendering objects)
...
box2_VAO = create_object_VAO(vertices_box2, indices_box1, vertices_box1.itemsize * 8, 0, 20, 12)
box3_VAO = create_object_VAO(vertices_box3, indices_box1, vertices_box1.itemsize * 8, 0, 20, 12)
...
lightPos = np.array([5.2, 20.0, 15.0], dtype=np.float32) #AARDVAK
...
image = load_and_configure_texture("TEXTURE/steelhammer1.jpg", texture[15])
